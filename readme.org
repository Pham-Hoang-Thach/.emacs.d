...
#+begin_src elisp
  (use-package org-roam
    ...
    :custom
    (org-roam-directory "/mnt/pht/emacs/pkm")
  ...
  (setq org-roam-node-display-template
        (concat "${type:10} ${title:50} " (propertize "${tags:0}" 'invisible t)))
#+end_src
...
#+begin_src elisp
  ...
  ;; Set up bibliography
  (setq bibtex-completion-bibliography '("/mnt/pht/emacs/pkm/bibtex.bib"))
  ;; Set up notes
  (setq bibtex-completion-notes-path "/mnt/pht/emacs/pkm/")
...
#+begin_src elisp
  ;; Files
  (setq org-directory "/mnt/pht/emacs/gtd")
...
#+begin_src elisp
  (setq org-publish-project-alist
        '(("acb"
           :base-directory "/mnt/pht/emacs/roam/"         
           :recursive t                   
           :base-extension "org"
           :publishing-directory "/mnt/pht/emacs/export/acb"
...
#+begin_src elisp
  (with-eval-after-load 'org
    ...
    (setq org-yank-image-save-method "/mnt/pht/emacs/img/")
