...
#+begin_src elisp
  (use-package edraw
    :load-path "~/.emacs.d/github/el-easydraw"
    :commands (edraw-mode)
    :init
...
#+begin_src elisp
  (use-package phscroll
    :load-path "~/.emacs.d/github/phscroll" 
...
#+begin_src elisp
  (defun my/org-latex-clear-source-folder (&rest _)
    "Deletes all export artifacts, leaving only the .org file in the source folder."
    (let* ((base (file-name-sans-extension (buffer-file-name)))
           (dir (file-name-directory (buffer-file-name)))
           (node-name (file-name-nondirectory base))
           ;; List of extensions to kill
           (extensions '("pdf" "tex" "aux" "log" "out" "bbl" "blg" "toc" "fdb_latexmk" "fls"))
           ;; Minted folder pattern: _minted-filename
      ...
      ;; 2. Remove minted directory
      (when (file-directory-p minted-dir)
        (delete-directory minted-dir t))))

  ;; Trigger this every time you publish a PDF
