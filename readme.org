...
#+begin_src elisp
  (use-package org-roam
    ...
    :custom
    (org-roam-directory "/mnt/pht/emacs/roam")
  ...
  (setq org-roam-node-display-template
        (concat "${type:10} ${title:50} " (propertize "${tags}" 'face 'org-tag)))
#+end_src
...
#+begin_src elisp
  ...
  ;; Set up bibliography
  (setq bibtex-completion-bibliography '("/mnt/pht/emacs/roam/bibtex.bib"))
  ;; Set up notes
  (setq bibtex-completion-notes-path "/mnt/pht/emacs/roam/")
