...
#+begin_src elisp
  (use-package org-noter
    ;;(setq org-noter-notes-search-path '("/mnt/thach/ws/emacs/noter"))
    :init
...
#+begin_src elisp
  (use-package org-roam
    ...
    :custom
    (org-roam-directory "/mnt/thach/ws/emacs/roam")
...
#+begin_src elisp
  ...
  ;; Set up bibliography
  (setq bibtex-completion-bibliography '("/mnt/thach/ws/emacs/gtd/bibtex.bib"))
  ;; Set up notes
  (setq bibtex-completion-notes-path "/mnt/thach/ws/emacs/roam/")
...
#+begin_src elisp 
  ...
  (require 'ess-site)
  (ess-toggle-underscore nil) ;leave underscore key alone!x
  ...
  See `org-capture-templates' for more information."
    ...
    (add-to-list 'org-capture-templates
                 '("h"                ;`org-capture' binding + h
                   ...
                   (file+olp "/mnt/thach/ws/academic-theme/content-org/all-posts.org" "Blog Ideas")
...
#+begin_src elisp
  ;; Files
  (setq org-directory "/mnt/thach/ws/emacs/gtd")
  (setq org-agenda-files '("/mnt/thach/ws/emacs/gtd"))
